...
MochiKit.DOM.updateNodeAttributes(elem,{"style":{"opacity":o,"-moz-opacity":o,"-khtml-opacity":0,"filter":" alpha(opacity="+(o*100)+")"}});
...
var _522=Math.round(num).toString(16);
if(num<16){
return "0"+_522;
}
return _522;
