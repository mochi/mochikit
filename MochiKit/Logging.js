...
MochiKit.Logging.__new__ = function () {
    ...
    var logLevelAtLeast = function (minLevel) {
        /***
    ...
    var LogMessage = function (num, level, info) {
        this.num = num;
        this.level = level;
        this.info = info;
    ...
    var Logger = function (/* optional */maxSize) {
        /***
    ...
    var alertListener = function (msg) {
        /***
    ...
    var NAMES = [
        ["LogLevel", LogLevel],
        ["logLevelAtLeast", logLevelAtLeast],
