...
AdapterRegistry.prototype.register = function (name, check, wrap, /* optional */ override) {
    /***
        ...
        If override is given and true, the check function will be given highest
        priority.  Otherwise, it will be the lowest priority adapter.
