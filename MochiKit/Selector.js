...
MochiKit.Base.update(MochiKit.Selector, {
    ...
    findRelatedElements: function (element, exp) {
        element = MochiKit.DOM.getElement(element);
        var m = MochiKit.Base;
        var expressions = m.flattenArguments(m.extend(null, arguments, 1));
        return m.flattenArray(m.map(function (expression) {
...
/*!
 * The rest of this file is Sizzle with some monkeypatches applied (search for MochiKit)
 * See: http://github.com/jeresig/sizzle/tree/master/sizzle.js
 * This version commit 9babb8dbc88fad712a0c305753a6cd61f4a89688
