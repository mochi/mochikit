...
MochiKit.Async.__new__ = function () {
    ...
    var CancelledError = function (deferred) {
        /***
    ...
    var BrowserComplianceError = function (msg) {
        /***
    ...
    var XMLHttpRequestError = function (req, msg) {
        /***
    ...
    var evalJSONRequest = function (req) {
        /***
    ...
    var succeed = function (/* optional */result) {
        /***
    ...
    var fail = function (/* optional */result) {
        /***
    ...
    var doSimpleXMLHttpRequest = function (url) {
        /***
    ...
    var NAMES = [
        ...
        ["BrowserComplianceError", BrowserComplianceError],
        ["GenericError", GenericError],
        ["XMLHttpRequestError", XMLHttpRequestError],
        ["Deferred", Deferred],
        ["evalJSONRequest", evalJSONRequest],
        ["succeed", succeed],
        ["fail", fail],
        ["doSimpleXMLHttpRequest", doSimpleXMLHttpRequest],
        ["loadJSONDoc", loadJSONDoc]
    ];
